<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <div class="newsletter-form">
                            <form action="dadosemail" method="post">
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2020 Projetos Rio. <a href="http://www.projetos-rio.com.br" target="_blank">projetos-rio.com.br</a></p>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="/res/site/js/enviar.js"></script>
  </body>
</html>