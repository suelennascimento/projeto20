                            ...
                            <div class="product-inner">
                                ...
                                <div role="tabpanel">
                                    <ul class="product-tab" role="tablist">
                                        <li role="presentation" class="active"><a href="#home"aria-controls="home" role="tab" data-toggle="tab">Descrição</a>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="home">
                                            ...
                                            <h2><?php echo htmlspecialchars( $product["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h2>  
                                            <p><?php echo htmlspecialchars( $product["descritict"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="profile">
                                            ...
                                            <div class="submit-review">
                                                ...
                                                <p><label for="name">Nome</label> <input name="nome" type="text" ></p>
                                                ...
                                                <p><label for="review">Avaliação</label> <textarea name="avaliacao"  id="" cols="30" rows="10"></textarea></p>
